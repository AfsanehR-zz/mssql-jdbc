...
enum SQLServerDriverIntProperty {
    ...
    CANCEL_TIMEOUT                              ("cancelTimeout",                            -1),
    ;  
...
public final class SQLServerDriver implements java.sql.Driver {
    ...
    private static final SQLServerDriverPropertyInfo[] DRIVER_PROPERTIES =
    {
        ...
        new SQLServerDriverPropertyInfo(SQLServerDriverIntProperty.CANCEL_TIMEOUT.toString(),                                  Integer.toString(SQLServerDriverIntProperty.CANCEL_TIMEOUT.getDefaultValue()),                           false,      null),
